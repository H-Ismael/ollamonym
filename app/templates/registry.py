...
class TemplateRegistry:
    ...
    def __init__(self, templates_dir: Path, custom_templates_dir: Optional[Path] = None):
    ...
    def reload(self) -> None:
        ...
        templates = load_all_templates(self.templates_dir)
        if self.custom_templates_dir:
            # Custom templates override bundled templates with same ID.
            templates.update(load_all_templates(self.custom_templates_dir))
    ...
    def get_template(self, template_id: str) -> Optional[TemplateSchema]:
        ...
        if template_id not in self.templates:
            ...
            template = None
            if self.custom_templates_dir:
                template = load_template_by_id(template_id, self.custom_templates_dir)
            if not template:
